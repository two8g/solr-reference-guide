...
本节介绍如何安装 Solr. 你可以在任何具备 Java 运行时环境的系统安装 Solr, 详细如下. 目前包含 Linux, OS X, Windows系统安装说明. 此说明适应任何版本, 除了少量 Windows 版本.
...
解压之后,你就可以阅读 [Running Solr](Running_Solr.md) 章节学习运行 Solr.